...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".navbar{display:flex;justify-content:space-between;align-items:center}.logo-top{font-size:6rem;text-decoration:none;color:#252322;padding:40px;font-family:\"JMH Typewriter Dry\";font-weight:700}.logo-top:hover{text-decoration:none;color:#fff}.navigation-links ul{list-style:none;display:flex;justify-content:center;margin:0}.navigation-links li{text-decoration:none;font-size:2.5rem;padding:40px;font-family:\"JMH Typewriter Dry\";font-weight:700}.navigation-links li a{color:#252322}.navigation-links li a:hover{opacity:.8;text-decoration:none}@media(max-width:1300px){.navigation-links li{padding:15px}}@media(max-width:1180px){.navigation-links{display:none}@media(max-width:768px){.navbar{display:flex;justify-content:center}}@media(max-width:560px){.logo-top{font-size:3.5rem}}}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/Navbar.vue?vue&type=template&id=520bd807&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"navbar"},[_vm._ssrNode("<div id=\"top\" class=\"logo-home\"><a href=\"#top\" class=\"logo-top\">aaamine*</a></div> <div class=\"navigation-links\"><ul><li><a href=\"#about\">About</a></li> <li><a href=\"#services\">Services</a></li> <li><a href=\"#contact\">Contact</a></li></ul></div>")])}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/Navbar.vue?vue&type=template&id=520bd807&
